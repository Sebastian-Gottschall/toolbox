				...
				<ul class="nav navbar-nav">
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu" role="menu">
							...
							<li><a href="{{url('contentgroups')}}">Inhaltsgruppen</a></li>
							<li><a href="{{url('users')}}">Benutzer</a></li>
						</ul>
					</li>

					<li><a href="{{url('favourites')}}">Favoriten</a></li>
					<li><a href="{{url('contents')}}">Inhalte</a></li>
